...
export const es: Catalogue = {
  ...
  parcours: {
    ...
    scoreMonteCollaboration: 'Una colaboración cumplida',
    scoreMonteDansLesTemps: 'Publicar antes del plazo',
    scoreMonteDuPremierCoup: 'Hacerlo bien a la primera',
    scoreDescendAbsence: 'No presentarte',
    scoreDescendNonHonoree: 'Una publicación nunca entregada',
    scoreDescendEnRetard: 'Publicar después del plazo',
    scoreDescendReprise: 'Que te pidan enviarlo de nuevo',
