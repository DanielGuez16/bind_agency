...
export const es: Catalogue = {
  ...
  parcours: {
    ...
    preuveEchecTitre: 'No se envió. Tu foto sigue aquí.',
    ...
    preuveApercuEntier: 'Se muestra entera, con las barras del sistema. Nunca la recortamos: lo que importa es que se lean la publicación, la mención y el lugar.',
    ...
    ongletAEnvoyerAide: 'Ya has publicado. Envía la captura para que el negocio pueda comprobarla.',
