...
export const es: Catalogue = {
  ...
  composition: {
    ...
    ouverture: 'Apertura',
    capaciteExplication: 'Cuándo abres, y cuántas creadoras puedes aceptar a la vez. Independiente de tu agenda habitual de clientas.',
    modifier: 'Editar',
    enregistrer: 'Guardar',
    ferme: 'Cerrado',
    fermerCeJour: 'Cerrar este día',
    postes: '{{n}} creadoras a la vez',
    postesUn: 'Una creadora a la vez',
