...
export const es: Catalogue = {
  ...
  parcours: {
    ...
    ficheCarteVoir: 'Ver la carta',
    ficheCarteFermer: 'Ocultar la carta',
    ficheCarteEnLigne: 'Abrir la carta en línea',
    ficheCarteHorsApp: 'Esto se abre fuera de la app.',
  ...
  composition: {
    ...
    cartePourquoi: 'Una prestación que deja elegir no se publica hasta que añadas páginas de la carta o un enlace.',
