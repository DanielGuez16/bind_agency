...
export const es: Catalogue = {
  ...
  tiers: {
    ...
    ouvertMaintenant: '{{count}} servicios que puedes reservar en el nivel {{palier}}',
  ...
  abonnement: {
    ...
    actifCorps: 'Tu negocio aparece en el directorio.',
    actifJusquA: 'Pagada hasta el {{date}}. Tu negocio aparece en el directorio.',
  ...
  profil: {
    ...
    declareQuiLit: 'Los salones lo ven cuando te buscan en su directorio.',
    declarePrenom: 'Nombre',
    declareNom: 'Apellido',
    declareVille: 'Ciudad',
  ...
  parcours: {
    ...
    audiencePasEncoreDeScoreDetail:
      'Empieza tras tu primera colaboración. Hasta entonces el nivel story está desbloqueado para ti, como para todas.',
    ...
    tiersVide: 'Todavía no has desbloqueado ningún nivel.',
    ...
    filCompte: '{{count}} servicios',
    filCompteUn: 'Un servicio',
    ...
    carteCoeurRetirer: 'Quitar de guardados los {{count}} servicios de {{nom}}',
    carteCoeurRetirerUn: 'Quitar de guardados este servicio de {{nom}}',
    ...
    ficheSemaineTitre: 'Horario',
    ficheSemaineOuvrir: 'Ver el horario',
    ficheSemaineFermer: 'Ocultar el horario',
    ficheSemaineReserve: 'Semana habitual. No incluye festivos ni cierres puntuales.',
    ficheAccordPrealable: 'Este salón confirma cada reserva. Te avisarán antes de que quede fijada.',
    ficheAppeler: 'Llamar a {{nom}}',
    ficheOuvertJusqua: 'Abierto hasta las {{heure}}',
    ficheDuree: '{{count}} minutos',
    fichePhotosCompte: '{{count}} fotos',
    fichePhotosCompteUne: 'Una foto',
    ficheOuvertes: '{{count}} que puedes reservar',
    fichePasEncoreCompte: '{{count}} aún sin desbloquear',
    ficheCompteOuvrirait: '{{count}} servicios más si conectas {{reseau}}',
    ficheConnecter: 'Conectar {{reseau}}',
    ...
    ouEstLeLieuDistance: 'A {{distance}} en línea recta',
    ouEstLeLieuSansPosition: 'Comparte tu ubicación y aquí verás a qué distancia está.',
    ouEstLeLieuOuvrir: 'Abrir en Mapas',
    contrepartieAvant: 'Una ',
    contrepartieApres: ' en {{plateforme}}, en {{heures}} h',
    ficheFerme: 'Se muestra para que sepas que existe. Aún no está desbloqueado para ti.',
    ...
    creneauPris: 'Acaban de tomar las {{heure}}.',
    creneauPrisRestants: 'Alguien reservó antes que tú. Estas siguen libres hoy.',
    creneauPrisPlusRien: 'Alguien reservó antes que tú, y hoy no queda nada más. Los otros días están justo debajo.',
    creneauConfirmerPour: 'Confirmar {{heure}}',
    ...
    fichePhotosDetailUne: 'Una foto · la sala y los platos',
    ficheCarte: 'Carta',
    ficheCartePages: '{{count}} páginas · léela antes de reservar',
    ficheCartePagesUne: 'Una página · léela antes de reservar',
    ...
    moment_jour: '{{jour}} a las {{heure}}',
    moment_date: '{{jour}} a las {{heure}}',
    sectionMontreTonCode: 'MUESTRA TU CÓDIGO',
    sectionLeSalonDecide: 'ESPERANDO AL SALÓN',
    annuler: 'Anular',
    annulerLibreJusqua: 'Puedes anular sin coste hasta las {{heure}}',
    ...
    annulerFiabiliteRemonte: 'Tu fiabilidad se recupera al cumplir las siguientes.',
    annulerEtPrevenir: 'Anular y avisar a {{salon}}',
    annulerGarder: 'Mantenerla, voy a ir',
    dureeMinutes: '{{n}} min',
    ...
    issueClose: 'Cerrada',
    publiee: 'Tu publicación',
    publieeOuvrir: 'Tu publicación. Ábrela',
    ...
    action_preuve: 'Enviar comprobante…',
    ...
    preuveMentionLibelle: 'Menciona esta cuenta',
    preuveLieuLibelle: 'Etiqueta este lugar',
    preuveCopier: 'Copiar',
    preuveCopie: 'Copiado',
    preuveEcheance: 'Antes del {{date}}',
    preuveEnvoyer: 'Enviar mi comprobante',
    preuveDepuisGalerie: 'Elegir una foto o un vídeo',
    preuvePrendrePhoto: 'Grabar o hacer una ahora',
    preuveContraintes: 'Foto o vídeo, {{poids}} MB como máximo.',
    preuveChoisirAutre: 'Elegir otra',
    preuveEnvoyerCelle_ci: 'Enviar esta',
    preuveEnvoiEnCours: 'Enviando tu prueba…',
    preuveEchecTitre: 'No se envió. Lo que elegiste sigue aquí.',
    preuveEchecCorps: 'Se cortó la red, no tu prueba. No se contó nada y no se perdió nada.',
    preuveEchecTentative: 'Intento {{n}} de {{total}}, sigue siendo {{n}} de {{total}}.',
    preuveReessayer: 'Reintentar',
    preuveApercuEntier: 'Se muestra sin recortar. Lo que importa es que se lean la publicación, la mención y el lugar.',
    preuveEnvoiInterrompu: 'El envío se detuvo al salir de la app. Lo que elegiste sigue aquí.',
    preuveEcheanceTient: 'Sin prisa, aguanta.',
    preuveEcheanceProche: 'Vence pronto. Mejor con wifi, si tienes.',
    preuveTropLourde: 'Ese archivo pesa demasiado. {{poids}} MB como máximo: tu teléfono puede exportar uno más ligero.',
    ...
    preuveVite:
      'Después tu historia ya no está en Instagram, y solo nos quedan tu envío y tu palabra. El salón acepta ambos. El primero es más fácil para las dos.',
    ...
    preuveAdresseAide:
      'Pega el enlace de la publicación. El negocio lo abre para comprobar que sigue en línea. Sin él, tiene que creerte.',
  ...
  commerce: {
    ...
    jourAvecDecisions: '{{jour}}, {{count}} por responder',
    journeeFinies: '{{count}} terminadas hoy',
    exceptionTitre: 'Solo hoy',
    ...
    selecteurDecisions: '{{count}} esperando',
    menuVotreOffre: 'TU OFERTA',
    menuEnArriere: 'MIRANDO ATRÁS',
    menuLieuEtat: 'Fotos, dirección, horario, plazas',
    menuPrestationsEtat: '{{ouvertes}} abiertas',
    menuPrestationsEtatPhoto: '{{ouvertes}} abiertas · {{sans}} sin foto',
    menuRapportsEtat: '{{prestations}} prestaciones dadas, {{publications}} publicaciones',
    menuRapportsVide: 'Todavía no hay nada que informar',
    menuAnnuaireEtat: 'Quién puede reservarte, y a qué distancia',
    ...
    exceptionChargement: 'Comprobando el horario de hoy…',
    exceptionJourFerme: 'Este día está cerrado en tu semana, así que no hay nada que recortar hoy. Abre el día en tu semana para recibir reservas.',
    ...
    suspenduTitrePause: 'Estás en pausa',
    suspenduTitreGrace: 'Tu suscripción ha vencido',
    suspenduPause: 'Tú misma te quitaste del muro, y tú misma vuelves a ponerte. No se pierde nada de lo que construiste.',
    suspenduGrace: 'El periodo de gracia terminó sin suscripción. Al suscribirte vuelves al muro.',
    suspenduSansMotif: 'Ahora mismo las creadoras no pueden verte.',
    suspenduDepuis: 'Desde el {{date}}',
  ...
  admin: {
    ...
    abonnesColonneEtat: 'Suscripción',
    abonnesColonneDepuis: 'Desde',
    abonnementEtat_active: 'En curso',
    abonnementEtat_trialing: 'Prueba',
    abonnementEtat_past_due: 'Pago atrasado',
    abonnementEtat_canceled: 'Detenida',
    abonnementEtat_incomplete: 'Sin terminar',
    abonnementEtat_unpaid: 'Sin pagar',
    createursTitre: 'Creadores',
    createursSousTitre: 'Todos los que tienen una cuenta. Los más recientes primero.',
    createursRecherche: 'Buscar por seudónimo',
    createursVide: 'Ningún creador se ha registrado todavía.',
    createursVideRecherche: 'Ningún seudónimo coincide con esta búsqueda.',
    createursColonneCreatrice: 'Creadora',
    createursColonneVille: 'Ciudad',
    createursColonneReseau: 'Red',
    createursColonneAudience: 'Seguidores',
    createursColonneFiabilite: 'Fiabilidad',
    createursSansVille: 'Sin ciudad indicada',
    createursSansScore: 'Sin historial',
    createursOuvrir: 'Abrir perfil',
    createursOuvrirLeProfil: 'Abrir el perfil de {{pseudonyme}}',
    createursFiabiliteRaison:
      'La fiabilidad aparece aquí y en ningún otro sitio. Un comercio nunca ve este número: el nivel que una creadora alcanza ya lleva lo que un salón necesita para decidir.',
    createursSansReseau: 'Sin red conectada',
    createursColonneTier: 'Nivel',
    createursSansPalier: 'Todavía ninguno',
    createursSurBind: 'en BIND',
    createursPeuventReserver: 'pueden reservar hoy en algún sitio',
    createursArriveesCetteSemaine: 'se unieron esta semana',
    createursFiabiliteMedianeLegende: 'fiabilidad mediana',
    createursFiabiliteMedianeAvecEffectif: '{{valeur}}, fiabilidad mediana de {{effectif}} creadoras con puntuación',
    createursPlafond: 'Se muestran las primeras {{count}}. Acota el nombre en vez de desplazarte.',
    createursAbonnes: '{{n}} seguidores en total',
    commercesTitre: 'Salones',
    commercesRecherche: 'Buscar por nombre',
    commercesRecherchePlaceholder: 'Vela Nail Studio',
    commercesColonneNom: 'Salón',
    commercesColonneQuartier: 'Barrio',
    commercesColonneEtat: 'Estado',
    commercesColonneInscrit: 'Alta',
    ...
    commercesVide: 'Todavía no se ha creado ningún salón.',
    commercesVideRecherche: 'Ningún salón coincide con ese nombre. Prueba con uno más corto.',
    commercesPlafond: 'Mostrando los primeros {{count}}. Afina el nombre en vez de desplazarte: más allá, un salón que existe se lee como uno que no.',
    commerceDraft: 'Preparado en el local',
    commerceOnboarding: 'En alta',
    commerceActive: 'Abierto',
    ...
    arbitrageTitre: 'Publicaciones en revisión',
    arbitrageVide: 'Ninguna publicación espera una decisión.',
  ...
  auth: {
    ...
    naissanceTitre: 'Fecha de nacimiento',
    naissanceJour: 'Día',
    naissanceMois: 'Mes',
    naissanceAnnee: 'Año',
    naissanceAide: 'Solo números, cuatro cifras para el año.',
  ...
  favoris: {
    ...
    videCorps: 'El corazón de un servicio lo guarda aquí, útil para lo que aún no tienes desbloqueado.',
    duree: '{{n}} min',
    ...
    palierSansChiffre: 'Nivel {{palier}} · hay otra cosa en el camino',
  ...
  reglages: {
    ...
    repriseParSpontanee: '{{qui}}, por iniciativa propia.',
    repriseParDemandee: '{{qui}}, después de que lo pidieras.',
    repriseEcrans: 'Podía abrir: {{ecrans}}',
    porteeSeparateur: ', ',
    porteeFiche: 'tu ficha',
    porteeCatalogue: 'tus servicios',
    porteeAgenda: 'las reservas del día',
    porteeContreparties: 'publicaciones y pruebas',
    porteeAnnuaire: 'el directorio de creadores',
    porteeAbonnement: 'tu suscripción',
    porteeChiffres: 'tus cifras',
    repriseRefermerAction: 'Cerrar este acceso ahora',
    repriseRefermerEnCours: 'Cerrando',
    titre: 'Ajustes',
    compte: 'Cuenta',
    ...
    supprimerHonorees: 'Las reservas que ya has aceptado se cumplen antes de borrar nada. Eliminar tu cuenta no las cancela.',
    supprimerAction: 'Eliminar mi cuenta',
    supprimerIdentifiant: 'Escribe tu correo para confirmar',
    supprimerMotDePasse: 'Tu contraseña',
    supprimerMotDePasseFaux: 'Esa contraseña no es la correcta.',
    supprimerRenoncer: 'Déjalo',
  ...
  lieu: {
    ...
    handleInstagram: 'Cuenta de Instagram',
    handleInstagramAide: 'El @nombre que las creadoras mencionan en su publicación. No es el enlace de arriba.',
    lienTiktok: 'TikTok',
    ...
    carteCompteUne: 'Una página',
    carteBloque: '{{count}} servicios no pueden publicarse sin ella',
    carteBloqueUn: 'Un servicio no puede publicarse sin ella',
    joursOuverts: 'Abierto {{count}} días por semana',
    joursOuvertsUn: 'Abierto un día por semana',
    titre: 'Tu local',
  },
  composition: {
    mentionLabel: 'Cuenta que mencionar',
    mentionAide: 'Lo que la creadora escribe en su publicación. Déjalo vacío si no pides ninguna.',
    lieuLabel: 'Pedir una etiqueta de ubicación',
    enregistrerLesCriteres: 'Guardar lo que esperas',
    ...
    photoTitre: 'Foto de este servicio',
    ...
    importCarteLecture: 'Leyendo tu carta. Tarda unos segundos.',
    importCarteEchec: 'No pudimos leer este archivo. Prueba con otra foto, o añade tus servicios a mano.',
    importCartePermission: 'BIND necesita acceso a tus fotos para leer tu carta.',
    filtreToutes: 'Todos',
    ...
    ouverture: 'Apertura',
    colonneJour: 'Día',
    colonneOuvert: 'Abierto',
    sectionChaqueSemaine: 'Cada semana',
    capaciteExplication: 'Cuándo pueden reservarte las creadoras.',
    modifier: 'Editar',
    enregistrer: 'Guardar',
    ferme: 'Cerrado',
    ...
    champPostes: 'Cuántos sillones reservas para creadoras',
    lundi: 'Lun',
    mardi: 'Mar',
    mercredi: 'Mié',
    jeudi: 'Jue',
  ...
  terrain: {
    ...
    colonneSalon: 'Salón',
    colonnePreparePar: 'Preparada por',
    colonnePrepare: 'Preparada',
    colonneVoie: 'Entregada cómo',
    colonneEtat: 'Estado',
    colonneAttente: 'Espera',
    voieEnMain: 'En persona',
    voieParLien: 'Por correo',
    voiePasEncore: 'Sin entregar',
    attenteMise: '{{n}} h',
    attenteDepuis: '{{n}} h hasta ahora',
    attenteAucune: 'Ninguna',
  ...
  errors: {
    ...
    age_below_minimum: 'Necesitas tener 18 años o más para usar BIND.',
    birth_date_in_future: 'Esa fecha está en el futuro. Revisa el año.',
    birth_date_implausible: 'Esa fecha no parece correcta. Revisa el año.',
    ...
    support_scope_required: 'Indica qué pantallas abre este acceso.',
