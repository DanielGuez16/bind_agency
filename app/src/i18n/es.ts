...
export const es: Catalogue = {
  ...
  commerce: {
    ...
    decisionSiElleNePubliePas: 'Si no publica lo acordado, su puntuación de fiabilidad baja — y esa puntuación es la que le abre o le cierra los niveles, en tu negocio y en todo BIND.',
