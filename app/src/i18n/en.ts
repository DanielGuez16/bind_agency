...
export const en = {
  ...
  parcours: {
    ...
    ficheSemaineTitre: 'Opening hours',
    ficheSemaineOuvrir: 'Show opening hours',
    ficheSemaineFermer: 'Hide opening hours',
    ficheSemaineReserve: 'Usual week. Holidays and one-off closures are not shown here.',
    ficheAccordPrealable: 'This salon confirms each booking. You will hear back before it is set.',
    ficheAppeler: 'Call {{nom}}',
  ...
  admin: {
    ...
    abonnesColonneEtat: 'Subscription',
    abonnesColonneDepuis: 'Since',
    abonnementEtat_active: 'Running',
    abonnementEtat_trialing: 'Trial',
    abonnementEtat_past_due: 'Payment late',
    abonnementEtat_canceled: 'Stopped',
    abonnementEtat_incomplete: 'Not finished',
    abonnementEtat_unpaid: 'Unpaid',
    createursTitre: 'Creators',
    createursSousTitre: 'Everyone who has an account. Newest first.',
    createursRecherche: 'Search by handle',
    createursVide: 'No creator has signed up yet.',
    createursVideRecherche: 'No handle matches this search.',
    createursColonneCreatrice: 'Creator',
    createursColonneVille: 'City',
    createursColonneReseau: 'Network',
    createursColonneAudience: 'Followers',
    createursColonneFiabilite: 'Reliability',
    createursSansVille: 'No city given',
    createursSansScore: 'No record',
    createursOuvrir: 'Open profile',
    createursOuvrirLeProfil: 'Open the profile of {{pseudonyme}}',
    createursFiabiliteRaison:
      'Reliability appears here and nowhere else. A business never sees this number: the tier a creator can reach already carries what a salon needs to decide.',
    createursSansReseau: 'No network connected',
    createursColonneTier: 'Tier',
    createursSansPalier: 'None yet',
    createursSurBind: 'on BIND',
    createursPeuventReserver: 'can book somewhere today',
    createursArriveesCetteSemaine: 'joined this week',
    createursFiabiliteMedianeLegende: 'median reliability',
    createursFiabiliteMedianeAvecEffectif: '{{valeur}}, median reliability of {{effectif}} creators with a score',
    createursPlafond: 'Showing the first {{count}}. Narrow the name rather than scroll.',
    createursAbonnes: '{{n}} followers in total',
    ...
    arbitrageTitre: 'Publications in review',
    arbitrageVide: 'No publication is waiting for a decision.',
  ...
  composition: {
    ...
    importCarteLecture: 'Reading your menu. This takes a few seconds.',
    importCarteEchec: 'We could not read this file. Try another photo, or add your services by hand.',
    importCartePermission: 'BIND needs access to your photos to read your menu.',
    filtreToutes: 'All',
    filtreOuvertes: 'Open',
    ...
    colonneJour: 'Day',
    colonneOuvert: 'Open',
    sectionChaqueSemaine: 'Every week',
    capaciteExplication: 'When creators can book you.',
    modifier: 'Edit',
    enregistrer: 'Save',
    ferme: 'Closed',
    ...
    champPostes: 'How many chairs you keep for creators',
    lundi: 'Mon',
    mardi: 'Tue',
    mercredi: 'Wed',
    jeudi: 'Thu',
  ...
  terrain: {
    ...
    colonneSalon: 'Salon',
    colonnePreparePar: 'Prepared by',
    colonnePrepare: 'Prepared',
    colonneVoie: 'Handed how',
    colonneEtat: 'State',
    colonneAttente: 'Wait',
    voieEnMain: 'In person',
    voieParLien: 'By email',
    voiePasEncore: 'Not handed yet',
    attenteMise: '{{n}} h',
    attenteDepuis: '{{n}} h so far',
    attenteAucune: 'None',
