...
export const en = {
  ...
  terrain: {
    ...
    bilanHeures: '{{n}} h',
    bilanEcart: 'Handed to the manager in person: {{enMain}} % activate. Sent by link: {{parLien}} %. Both routes are worth keeping — a link beats a lost visit — but the gap says a second pass to catch the manager pays more than a reminder.',
