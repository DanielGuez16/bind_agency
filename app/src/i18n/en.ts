...
export const en = {
  ...
  parcours: {
    ...
    ficheCarteVoir: 'See the menu',
    ficheCarteFermer: 'Hide the menu',
    ficheCarteEnLigne: 'Open the online menu',
    // Dit seulement quand le lien est la seule forme : sur un téléphone,
    // « revenir » n'est pas toujours un geste évident.
    ficheCarteHorsApp: 'This opens outside the app.',
  ...
  composition: {
    ...
    cartePourquoi: 'A service that lets the creator choose stays unpublished until you add menu pages or a link.',
